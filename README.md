About selenium-manager-feedstock
================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/selenium-manager-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/selenium-manager-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add selenium-manager
# for installing globally
pixi global install selenium-manager
```
...
It is possible to list all of the versions of `selenium-manager` available on your platform:
...
```
pixi search selenium-manager --channel conda-forge
```
